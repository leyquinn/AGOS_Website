<header class="portal-header border-b border-blue-950/60 bg-[#031027]/95 backdrop-blur-md">
    <div class="flex min-h-20 items-center justify-between gap-4 px-5 sm:px-8">
        ...
        <div class="flex items-center gap-1 rounded-2xl border border-blue-900/40 bg-blue-950/20 p-1">
            <div class="relative">
            ...
            <button type="button" data-theme-toggle class="rounded-xl border border-blue-800/50 bg-blue-950/40 p-2 text-blue-300 transition hover:border-blue-500" aria-label="Switch to light mode">
